...
def getResults(train_loader, scheduler, optimizer, model, loss_fn, n_epochs=1, device='cpu'):
    print("Evaluating ...")
    model.eval()
    input_output_list = []
...
def train(train_loader, scheduler, optimizer, model, loss_fn, n_epochs=12, device='cpu'):
    print("Training ...")
    model.eval()
    losses_train = []
    loss_list = []
